/**
 * Unified API Client with Enhanced Configuration
 *
 * This is the single IO exit point for all HTTP requests in the application.
 * It handles authentication, error handling, mock mode switching, and request/response interceptors.
 */
