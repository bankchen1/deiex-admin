 ...
 */
export async function handleListTradeReports(
  params: TradeReportQueryParams = {}
): Promise<TradeReportListResponse> {
  // Simulate API delay
 ...
 */
export async function handleListFinanceReports(
 ...
 */
export async function handleListRetentionReports(
  params: RetentionReportQueryParams = {}
): Promise<RetentionReportListResponse> {
  // Simulate API delay
  await new Promise((resolve) => setTimeout(resolve, 300 + Math.random() * 200))
 ...
 */
export async function handleGetTradeDailyData(params: {
  startDate?: string
  endDate?: string
  symbol?: string
}): Promise<TradeDailyData[]> {
  // Simulate API delay
 ...
 */
export async function handleGetSymbolVolumeData(params: {
  startDate?: string
  endDate?: string
  currency?: string
}): Promise<SymbolVolumeData[]> {
  // Simulate API delay
  await new Promise((resolve) => setTimeout(resolve, 200 + Math.random() * 100))
 ...
 */
export async function handleGetFinanceDailyData(params: {
  startDate?: string
  endDate?: string
  currency?: string
}): Promise<FinanceDailyData[]> {
  // Simulate API delay
  await new Promise((resolve) => setTimeout(resolve, 200 + Math.random() * 100))
 ...
 */
export async function handleGetFeeIncomeData(params: {
  startDate?: string
  endDate?: string
  feeType?: string
  currency?: string
}): Promise<FeeIncomeData[]> {
  // Simulate API delay
  await new Promise((resolve) => setTimeout(resolve, 200 + Math.random() * 100))
 ...
 */
export async function handleGetRetentionData(params: {
  startDate?: string
  endDate?: string
  period?: string
 ...
 */
export async function handleGetFunnelData(params: {
  startDate?: string
  endDate?: string
  step?: string
}): Promise<FunnelData[]> {
...
export async function handleExportTradeReport(params: ExportReportParams): Promise<Blob> {
  ...
  const csvContent =
    'id,symbol,date,volume,turnover,trades,takerBuyVolume,takerBuyTurnover\n' +
    mockData.tradeReports
      .map(
        (item) =>
...
export async function handleExportFinanceReport(params: ExportReportParams): Promise<Blob> {
  ...
  // Create mock CSV data
  const csvContent =
    'id,date,depositAmount,depositCount,withdrawalAmount,withdrawalCount,feeIncome,userCount,activeUserCount\n' +
    mockData.financeReports
      .map(
        (item) =>
...
export async function handleExportRetentionReport(params: ExportReportParams): Promise<Blob> {
  ...
  // Create mock CSV data
  const csvContent =
    'id,date,newUserCount,day1,day7,day30,day90,mtd,qtd,ytd\n' +
    mockData.retentionReports
      .map(
        (item) =>
