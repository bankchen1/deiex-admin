 ...
 */
export async function handleGetPublishedFunding(params: FundingRuleQueryParams = {}): Promise<FundingRuleListResponse> {
  // Simulate API delay
 ...
 */
export async function handleGetDraftFunding(params: FundingRuleQueryParams = {}): Promise<FundingRuleListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
 ...
 */
export async function handleGetFundingById(id: string, isDraft = false): Promise<FundingRuleDetailResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 400 + Math.random() * 300))
  
  const statusFilter = isDraft ? 'draft' : 'published'
  const fundingRule = mockData.fundingRules.find(rule => rule.id === id && rule.status === statusFilter)
 ...
 */
export async function handleCreateDraftFunding(payload: CreateFundingRulePayload): Promise<FundingRule> {
  // Simulate API delay
 ...
 */
export async function handleUpdateDraftFunding(id: string, payload: UpdateFundingRulePayload): Promise<FundingRule> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500 + Math.random() * 300))
...
export async function handleDeleteDraftFunding(id: string): Promise<boolean> {
  ...
  mockData.fundingRules = mockData.fundingRules.filter(rule => !(rule.id === id && rule.status === 'draft'))
 ...
 */
export async function handleGetPublishedMaintenance(params: MaintenanceWindowQueryParams = {}): Promise<MaintenanceWindowListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
  
  // Filter published maintenance windows
  const publishedWindows = mockData.maintenanceWindows.filter(window => window.status === 'published')
 ...
 */
export async function handleGetDraftMaintenance(params: MaintenanceWindowQueryParams = {}): Promise<MaintenanceWindowListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
 ...
 */
export async function handleGetMaintenanceById(id: string, isDraft = false): Promise<MaintenanceWindowDetailResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 400 + Math.random() * 300))
  
  const statusFilter = isDraft ? 'draft' : 'published'
  const maintenanceWindow = mockData.maintenanceWindows.find(window => window.id === id && window.status === statusFilter)
 ...
 */
export async function handleCreateDraftMaintenance(payload: CreateMaintenanceWindowPayload): Promise<MaintenanceWindow> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500 + Math.random() * 300))
 ...
 */
export async function handleUpdateDraftMaintenance(id: string, payload: UpdateMaintenanceWindowPayload): Promise<MaintenanceWindow> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500 + Math.random() * 300))
  
  const index = mockData.maintenanceWindows.findIndex(window => window.id === id && window.status === 'draft')
  if (index === -1) {
...
export async function handleDeleteDraftMaintenance(id: string): Promise<boolean> {
  ...
  mockData.maintenanceWindows = mockData.maintenanceWindows.filter(window => !(window.id === id && window.status === 'draft'))
 ...
 */
export async function handleGetPublishedAnnouncements(params: AnnouncementQueryParams = {}): Promise<AnnouncementListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
  
  // Filter published announcements
  const publishedAnnouncements = mockData.announcements.filter(announcement => announcement.status === 'published')
 ...
 */
export async function handleGetDraftAnnouncements(params: AnnouncementQueryParams = {}): Promise<AnnouncementListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
  
  // Filter draft announcements
  const draftAnnouncements = mockData.announcements.filter(announcement => announcement.status === 'draft')
 ...
 */
export async function handleGetAnnouncementById(id: string, isDraft = false): Promise<AnnouncementDetailResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 400 + Math.random() * 300))
  
  const statusFilter = isDraft ? 'draft' : 'published'
  const announcement = mockData.announcements.find(ann => ann.id === id && ann.status === statusFilter)
 ...
 */
export async function handleCreateDraftAnnouncement(payload: CreateAnnouncementPayload): Promise<Announcement> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500 + Math.random() * 300))
 ...
 */
export async function handleUpdateDraftAnnouncement(id: string, payload: UpdateAnnouncementPayload): Promise<Announcement> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500 + Math.random() * 300))
...
export async function handleDeleteDraftAnnouncement(id: string): Promise<boolean> {
  ...
  mockData.announcements = mockData.announcements.filter(ann => !(ann.id === id && ann.status === 'draft'))
...
export async function handleExportData(params: ExportParams): Promise<Blob> {
  ...
  const csvContent = "id,title,content,en,zh,ja,ko,createdAt\n" +
 ...
 */
export async function handleGetVersionHistory(params: VersionQueryParams = {}): Promise<{ data: Version[]; total: number; page: number; pageSize: number }> {
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200))
