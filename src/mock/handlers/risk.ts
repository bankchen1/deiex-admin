 ...
 */
export async function handleListRiskRules(params: RiskRuleQueryParams): Promise<RiskRuleListResponse> {
  // Simulate API delay
 ...
 */
export async function handleListRiskLimits(params: RiskLimitQueryParams): Promise<RiskLimitListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200));
 ...
 */
export async function handleListBlacklistEntries(params: BlacklistEntryQueryParams): Promise<BlacklistEntryListResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 300 + Math.random() * 200));
 ...
 */
export async function handleGetBlacklistEntryById(id: string): Promise<BlacklistEntryDetailResponse> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 400 + Math.random() * 300));
 ...
 */
export async function handleUpdateRiskRule(id: string, payload: UpdateRiskRulePayload): Promise<any> {
  // Simulate API delay
 ...
 */
export async function handleUpdateRiskLimit(id: string, payload: UpdateRiskLimitPayload): Promise<any> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 600 + Math.random() * 400));
 ...
 */
export async function handleCreateBlacklistEntry(payload: CreateBlacklistEntryPayload): Promise<any> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 700 + Math.random() * 500));
 ...
 */
export async function handleUpdateBlacklistEntry(id: string, payload: UpdateBlacklistEntryPayload): Promise<any> {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 600 + Math.random() * 400));
